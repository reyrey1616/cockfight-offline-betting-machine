      ...
      <div className="flex flex-col gap-2 border-b pb-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            {isAdmin
              ? 'Bets, balances, payouts, unpaid winners, and per-teller commission update in realtime. Cash advances and remittances use manual refresh.'
              : 'Bets, balances, payouts, and unpaid winners follow realtime. Cash advances and remittances refresh on demand.'}
          </p>
        </div>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
          {isAdmin ? (
            <div className="flex flex-col gap-1">
              <Label htmlFor="dash-teller" className="text-[10px] uppercase tracking-wide text-muted-foreground">
                Teller
              </Label>
              <select
                id="dash-teller"
