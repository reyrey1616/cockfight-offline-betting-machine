...
/** Inlined from machine-client `payout-receipt-slip-html.ts` — keep in sync. */
const PAYOUT_RECEIPT_SLIP_CSS = `
...
function buildPayoutReceiptHtml(fields) {
 ...
 */
export async function printPayoutReceipt(parentWin, receipt, config) {
  return printHtmlSlip(parentWin, buildPayoutReceiptHtml(receipt), config)
}
